 ...
 * @Last Modified time: 2018-03-09 07:25:02
 */
...
export const radarChartRequest = createAction(RADAR_CHART_REQUEST, 'username', 'page')
export const radarChartSuccess = createAction('RADAR_CHART_SUCCESS', 'user', 'logged')
